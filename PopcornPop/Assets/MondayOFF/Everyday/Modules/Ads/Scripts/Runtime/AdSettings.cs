...
#pragma warning disable CS0414
        ...
        [Header("OBSOLETE")]
        [SerializeField] internal LegacyPlayOn legacyPlayOn = default;
        [Space(20)]
        [Header("====== Adverty ======")]
...
#pragma warning restore CS0414
    ...
    [System.Serializable]
    internal class LegacyPlayOn {
        [SerializeField] internal bool useLegacyPlayOnPositioning = false;
        [Tooltip("Anchor position of logo ad")]
        [SerializeField][DrawIf("useLegacyPlayOnPositioning")] internal PlayOnSDK.Position playOnLogoAnchor = PlayOnSDK.Position.TopLeft;
        [Tooltip("Offset from anchor")]
        [SerializeField][DrawIf("useLegacyPlayOnPositioning")] internal Vector2Int playOnLogoOffset = new Vector2Int(0, 150);
        [Tooltip("Logo ad size")]
        [SerializeField][DrawIf("useLegacyPlayOnPositioning")] internal int playOnLogoSize = 64;
    }
}